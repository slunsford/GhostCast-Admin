...
export default Controller.extend({
    ...
    save: task(function* (options = {}) {
        ...
        this.set('post.episodeTitle', this.get('post.episodeTitleScratch'));
        this.set('post.episodeNumber', this.get('post.episodeNumberScratch'));
        this.set('post.episodeDescription', this.get('post.episodeDescriptionScratch'));
        this.set('post.audioUrl', this.get('post.audioUrlScratch'));
        this.set('post.audioDuration', this.get('post.audioDurationScratch'));
        this.set('post.audioSize', this.get('post.audioSizeScratch'));
