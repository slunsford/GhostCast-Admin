...
export default Model.extend(Comparable, ValidationEngine, {
    ...
    episodeTitle: attr('string'),
    episodeNumber: attr('number'),
    episodeDescription: attr('string'),
    audioUrl: attr('string'),
    audioDuration: attr('string'),
    audioSize: attr('number'),
    ...
    episodeTitleScratch: boundOneWay('episodeTitleScratch'),
    episodeNumberScratch: boundOneWay('episodeNumber'),
    episodeDescriptionScratch: boundOneWay('episodeDescription'),
    audioUrlScratch: boundOneWay('audioUrl'),
    audioDurationScratch: boundOneWay('audioDuration'),
    audioSizeScratch: boundOneWay('audioSize'),
